...
@section('content')
    ...
    <section class="flex justify-between py-10 px-[46px]">
        <div id="data-stok-container">
            <table class="border border-black border-2 w-[544px]">
                ...
                @foreach ($orders as $order)
                    <tr class="divide-x-2 divide-black border-bottom border-2 border-black">
                        ...
                        <td class="px-2 text-center">{{ strtoupper(implode(", ", explode(",", $order->jenjang))) }}</td>
                    </tr>
                @endforeach
            </table>
        </div>
        <div id="form-stok-container">
            <form action="" class="flex flex-col gap-6 items-end">
