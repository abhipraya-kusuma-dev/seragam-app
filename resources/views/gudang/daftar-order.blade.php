...
@section('content')
    ...
    <div class="current-page-bar-container px-[46px] mx-auto flex flex-col">
        <div class="current-page-bar flex gap-[13px] items-start">
            <a class=" py-2 px-4 bg-[#6C0345]/80 text-white/60 font-semibold rounded-b-lg border-black border hover:text-white hover:bg-[#6C0345] transition duration-500" href="">Buat
                Orderan</a>
    ...
    <div class="content-container px-[76px] w-full mt-[92px] mb-4 flex justify-between">
        <form action="" id="status-form">
            <select class="select-condition font-bold text-3xl focus:outline-none" name="status">
